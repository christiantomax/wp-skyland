<header>
    <nav id="navbar" class="bg-transparent fixed w-full z-40 py-2 xl:py-5 top-0 left-0">
        <div class="flex flex-wrap items-center justify-between mx-auto xl:ml-24 xl:mr-14 p-0 py-4 xl:py-0 md:p-4 text-3xl xl:text-lg text-white figtree-light">
            <a href="#" class="flex items-center">
                <img src="<?= $assets_folder_path.'img/logo.png';?>" class="h-8 mr-3 ms-4" alt="Logo" />
            </a>
            ...
            <div class="hidden w-full h-screen xl:h-fit xl:block xl:w-auto xl:pe-20" id="navbar-dropdown">
                <ul id="nav-service-dropdown" class="h-full xl:w-fit flex flex-col justify-between items-center font-medium py-16 xl:p-0 md:p-0 xl:bg-transparent xl:justify-start xl:flex-row xl:mt-0 xl:border-0">
                    <li>
                        <a href="#" class="block py-2 mx-6 rounded hover:text-gray-200 nav-service-dropdown__li" aria-current="about">About Us</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 mx-6 rounded hover:text-gray-200 nav-service-dropdown__li" aria-current="about">Property</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 mx-6 rounded hover:text-gray-200 nav-service-dropdown__li" aria-current="about">Investment</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 mx-6 rounded hover:text-gray-200 nav-service-dropdown__li" aria-current="about">Experience</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 mx-6 rounded hover:text-gray-200 nav-service-dropdown__li" aria-current="about">News</a>
                    </li>
                    <li>
