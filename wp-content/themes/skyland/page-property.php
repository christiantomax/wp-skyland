        ...
        <div class="bg-fixed w-11/12 flex bg-no-repeat bg-cover h-full pt-24">
            <div class="flex justify-between w-full">
                <div class="flex" >
                    ...
                    <div class="w-12/12">
                        <h2 class="figtree-light font-bold text-4xl mb-4">Foreword</h2>
                        <h1 class="figtree-light font-bold text-7xl mb-16"><strong>Where all things happens.</strong></h1>
                    </div>
                </div>
            </div>
        </div>
...
<section class="w-screen full-page flex flex-col items-center pb-20" id="project-list">
        <div class="w-10/12 h-full flex flex-col justify-center pb-2 ms-15">
    <?php
        for ($i = 0; $i < 3; $i++) {
    ?>
