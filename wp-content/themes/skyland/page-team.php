        ...
        <div class="bg-fixed w-11/12 flex bg-no-repeat bg-cover h-full pt-24 text-white">
            <div class="flex justify-between items-end w-full">
                <div class="flex items-end">
                    <div class="w-5/12">
                        <h1 class="figtree-light font-bold text-white text-7xl mb-0"><strong>Hello</strong></h1>
                    </div>
                    <div class="w-5/12">
                        <p class="text-white pt-1 text-ellipsis overflow-hidden">
        ...
        <div class="w-11/12 flex">\
            ...
            ?>
                <div class="w-6/12 team-person__container__image mb-16 me-2">
                    ...
                    <div class="flex text-white text-2xl mt-12">
                        <p>Name</p>
...
<section class="w-screen full-page flex justify-center" id="team-partners">
    <div class="bg-fixed w-11/12 bg-no-repeat bg-cover h-full pt-24">
        <div class="flex mb-16">
            ...
            <h1 class="figtree-light font-bold text-white text-6xl"><strong>Partners</strong></h1>
        </div>
    </div>
</section>
