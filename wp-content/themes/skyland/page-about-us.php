        ...
        <div class="w-full lg:w-10/12 mt-0 mt-10 lg:mt-20">
            <div class="flex">
                ...
                <div class="flex flex-col justify-between">
                    <p class="mt-5 lg:pt-1 ps-2 lg:ps-5 min-h-content text-ellipsis overflow-hidden text-2xl lg:text-5xl leading-normal">
                        <?= $quotes; ?>
                    </p>
...
<section class="w-screen full-page mb-20" id="properties-swiper">
    ...
    <div class="flex justify-start lg:justify-end mr-16 ms-20 lg:ms-0">
        <div class="flex explore-rotate-left">
            <p class="text-lg lg:text-2xl font-normal text-end me-3 figtree-light ">
                Explore more
            </p>
            <div class="flex items-end pb-1 icon animate-pulse">
                <img class="h-5" src="<?= $assets_folder_path.'/img/icon-arrow.png';?>"/>
