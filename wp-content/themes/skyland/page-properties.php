...
<?php
    $list_all_post = get_post_without_taxonomy("property_category", "");
                            ...
                            <ul class="w-full flex justify-between item-center text-2xl text-slate-300 figtree-light">
                                ...
                                <?php
                                    for ($i = 0; $i < $limit_posts; $i++) {
                                        ...
                                        ?>
                                            <li class="font-medium cursor-pointer">
                                                <a href="<?= $base_url."/properties?category=".$title_1;?>" class="<?= $getCategory == $title_1 ? 'font-bold text-white' : '';?>">
                                                    <?= $title_1;?>
                                                </a>
                                            </li>
                                        <?php
                                        ...
                                        <ul class="figtree-light text-white py-2 pl-8 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                            ...
                                            <?php
                                                for ($i = 0; $i < $limit_posts; $i++) {
                                                    ...
                                                    ?>
                                                        <li>
                                                            <a href="<?= $base_url."/properties?category=".$title_1;?>"" class="block px-4 py-2 hover:bg-gray-100 <?= $getCategory == $title_1 ? 'font-bold' : '';?>"><?= $title_1;?></a>
                                                        </li>
                                                    <?php
                                                }
                                            ?>
