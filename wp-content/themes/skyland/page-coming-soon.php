...
<?php 
    ...
    $instagram= rwmb_meta($prefix.$section.'instagram'.$languages);
    $email= rwmb_meta($prefix.$section.'email'.$languages);
    $facebook= rwmb_meta($prefix.$section.'facebook'.$languages);
?>
<!DOCTYPE html>
...
<body class="scroll-smooth bg-black text-white overflow-x-hidden relative">
        <section class="w-screen h-screen full-page relative" id="coming-soon">
            <div class="w-screen h-screen flex flex-col justify-between items-center bg-dark py-20" style="color: #BF955B;">
